...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-[120] border-b border-black/5 bg-white/90 px-4 py-1.5 backdrop-blur-xl shadow-[0_8px_30px_rgba(15,23,42,0.06)] sm:px-8 lg:px-10" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      <div className="mx-auto flex h-[3.5rem] w-full max-w-[1680px] items-center justify-center lg:justify-between gap-4 lg:grid lg:grid-cols-[1fr_auto_1fr] relative">
