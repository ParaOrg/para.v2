          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className={`${cardShell} p-6 sm:p-8 md:p-10`}>
              ...
              <div className="space-y-6">
                ...
                {/* __CONTACT_SOCIALS_PATCHED__ */}
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 bg-gray-100 rounded-xl flex items-center justify-center shrink-0">
                    <svg className="w-5 h-5 text-gray-900" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-gray-900 font-bold text-lg mb-2">X</h3>
                    <a href="https://x.com/para_commute" target="_blank" rel="noreferrer" className="text-purple-800 hover:text-purple-900 transition-colors text-base break-all">
                      x.com/para_commute
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-gray-900 font-bold text-lg mb-2">TikTok</h3>
                    <a href="https://www.tiktok.com/@para.commute" target="_blank" rel="noreferrer" className="text-purple-800 hover:text-purple-900 transition-colors text-base break-all">
                      tiktok.com/@para.commute
                    </a>
                  </div>
                </div>
              </div>
