...
export default function HomeNew() {
  ...
  return (
    <div className="fixed inset-0">
      ...
      <RailNetworkOverlay map={window.__paraMap} /></div>
      ...
      <div className="md:hidden absolute inset-0 z-50 pointer-events-none">
        ...
        <button onClick={locateMap} className="pointer-events-auto absolute top-4 right-4 z-[9999] bg-white w-11 h-11 rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 border border-gray-200"><GpsIcon /></button><button onClick={() => setShowWeather(true)} className="pointer-events-auto absolute top-16 right-4 z-[9999] bg-white w-10 h-10 rounded-full shadow-lg flex items-center justify-center text-lg hover:bg-gray-50 border border-gray-200">🌤️</button>
        {chatOpen && !showTracker && (
          <div className="pointer-events-auto absolute left-2 right-2 z-[60] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden" style={{ bottom: `calc(84px + ${kbOffset}px)`, maxHeight: showChat ? "50vh" : "auto", transition: "bottom 120ms ease-out" }}>
