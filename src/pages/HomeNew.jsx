...
export default function HomeNew() {
  ...
  return (
    <div className="fixed inset-0">
      ...
      <div className="fixed top-0 left-0 right-0 z-[9999] md:top-16 bg-amber-500 text-white text-center py-1.5 px-4 text-xs font-poppins font-medium shadow-md">
  ...
  if (idx > 0 && seg.path && seg.path.length > 0) {
    ...
    setRouteMarkers(prev => [...prev, { lat: transfer[0], lng: transfer[1], type: 'stop', label: 'Transfer' }]);
      ...
      <div className="md:hidden absolute inset-0 z-50 pointer-events-none">
        ...
        <button onClick={locateMap} className="pointer-events-auto absolute top-14 right-4 z-[9999] bg-white w-11 h-11 rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50 border border-gray-200"><GpsIcon /></button><button onClick={() => setShowWeather(true)} className="pointer-events-auto absolute top-26 right-4 z-[9999] bg-white w-10 h-10 rounded-full shadow-lg flex items-center justify-center text-lg hover:bg-gray-50 border border-gray-200">🌤️</button>
