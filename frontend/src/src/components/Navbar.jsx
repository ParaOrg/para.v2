...
export default function Navbar() {
  ...
  const visibleLinks = useMemo(() => ALL_NAV_LINKS.filter(l => !l.adminOnly || user?.role === 'admin'), [user]);
  const visibleLinks = NAV_LINKS.filter((link) => link.to !== "/admin" || user?.role === "admin");
